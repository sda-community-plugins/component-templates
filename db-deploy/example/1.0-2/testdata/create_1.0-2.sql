...
insert into "user" (username, password, name, email, mobile, enabled) values ('admin', '5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8', 'Administrator', 'admin@ring2park.com', '0887712345678', 1);
insert into "user" (username, password, name, email, mobile, enabled) values ('fred', '5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8', 'Fred Flintstone', 'fred@flintstones.com', '07777123123123', 1);
insert into "user" (username, password, name, email, mobile, enabled) values ('barney', '5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8', 'Barney Rubble', 'barney@flinstones.com', '0778845645677', 0);
insert into "user" (username, password, name, email, mobile, enabled) values ('wilma', '5baa61e4c9b93f3f0682250b6cf8331b7ee68fd8', 'Wilma Flintstone', 'wilma@flinstones.com', '07777123123124', 0);
...
insert into vehicle ("user", license, brand, color, preferred) values ('barney', 'IKL 012', 'Toyota', 'Blue', 0);
